...
public class BlockPipe extends BlockContainer implements IBlockPipe {
    ...
    public BlockPipe() {
        ...
        setUnlocalizedName(InnovativeTransport.MODID + ":transportpipe");
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, @Nullable ItemStack heldItem, EnumFacing side, float hitX, float hitY, float hitZ) {
        ...
        CardSlot slot = holder != null ? holder.pipe.getCardSlot(side) : null;
        if (slot != null) {
            playerIn.openGui(InnovativeTransport.INSTANCE, GuiTypes.CardSlot.ordinal(), worldIn, holder.getPos().getX(), holder.getPos().getY(), holder.getPos().getZ());
            return true;
        }
        return false;
    }
